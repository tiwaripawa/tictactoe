...
public class tictactoe {
    ...
    private void winningGame() {
        if (b1 == 1 && b2 == 1 && b3 == 1) {
            JOptionPane.showMessageDialog(frame, " X winns", "Tic Tac Toe", JOptionPane.INFORMATION_MESSAGE);
            xCount1++;
            ...
            JOptionPane.showMessageDialog(frame, " O winns", "Tic Tac Toe", JOptionPane.INFORMATION_MESSAGE);
            oCount1++;
            ...
            JOptionPane.showMessageDialog(frame, "its draw ", "Tic Tac Toe", JOptionPane.INFORMATION_MESSAGE);
        }
